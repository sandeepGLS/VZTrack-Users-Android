...
public class Visiters_Details extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (cc.isConnectingToInternet()) {
            ...
            mAdapter = new VisitList_RecyclerViewAdapter(context, getDataSet());
    ...
    public void onBackPressed() {
        ...
        MainActivity.Notiifcation_flag = "1";
        finish();
    }
    ...
    private ArrayList<DataObjectVisitList> getDataSet() {
        ...
        if (cc.isConnectingToInternet()) {
            ...
            DataObjectVisitList obj = new DataObjectVisitList(
                    first_name, last_name, date_and_time, out_time , purpose, from, whome_to_see, Vehicle_no, no_of_visitors, whome_to_see, error_flag, badgeNo
            );
            results.add(0, obj);
            return results;
        }
